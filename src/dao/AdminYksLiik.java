...
private String suletud;
	...
	public AdminYksLiik(String kood, String nimetus, String kommentaar) {
		this.kood = kood;
		this.nimetus = nimetus;
		this.kommentaar = kommentaar;
	}
        
        public AdminYksLiik(int id, String kood, String nimetus, String kommentaar) {
		this.id = id;
		this.kood = kood;
		this.nimetus = nimetus;
		this.kommentaar = kommentaar;
          ...
          public AdminYksLiik(int id, String kood, String nimetus, String kommentaar, String avaja, String avatud, String muutja, String muudetud, String sulgeja, String suletud) {
		this.id = id;
		this.kood = kood;
		this.nimetus = nimetus;
		this.kommentaar = kommentaar;
