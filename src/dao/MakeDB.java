...
public class MakeDB {
	...
	public MakeDB() throws SQLException {
		connection = ConnFactory.getInstance().getConnection();
		CreateDB();
	}
	...
	private void CreateDB() throws SQLException {
		...
		try {
			...
			stmt.executeUpdate("CREATE TABLE IF NOT EXISTS RIIGI_ADMIN_YKSUSE_LIIK (riigi_admin_yksuse_liik_id INTEGER IDENTITY PRIMARY KEY, kood VARCHAR(10) NOT NULL ,"
					...
					+ "sulgeja VARCHAR(32) NULL,"
					+ "suletud DATE NOT NULL ) ");
			// sisestame sinna administratiiv�ksused
			...
			// loome tabeli VOIMALIK_ALLUVUS NB! Rings�ltuvused pole lubatud,
			// aga praegu need v�listatud ei ole
